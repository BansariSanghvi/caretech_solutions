...
<?php  include("../common/navbar.php"); ?>
               ...
               <section class="analytics_section" id ='analytics'>
                  ...
                  <p class="desc" style="margin-left: 20px; margin-top: 20px;"></p>
                    ...
                    <div class="graph-container">
                        ...
                        <div class="graph">
                            <h5>Supply Order Frequency</h5>
                            <canvas id="supplyOrderBarChart"></canvas>
                        </div>
 ...
 <script>
    ...
    const ctxBar = document.getElementById('supplyOrderBarChart').getContext('2d');
    const appointmentsBarChart = new Chart(ctxBar, {
        type: 'bar',
        data: {
            labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
            datasets: [{
                label: 'Freq of Orders',
