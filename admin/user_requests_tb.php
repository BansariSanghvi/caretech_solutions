...
<body>
    <div class="container">
        ...
        <div class="main-content">
            ...
            <div class="inside-content">
                <section class="requests_section" id='requests_hub'>
                    <h2 class="page_title">User Requests:</h2>
    ...
    <script>
        function refreshTable() {
            ...
            $.ajax({
                url: "fetch_requests.php", // Fetch table data
                type: "GET",
                data: { department: selectedDepartment }, // Pass filter
                success: function (data) {
                    $('#requests-table-body').html(data); // Update table body
                },
