...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Get staff details
    $staff_query = "SELECT fname, lname, role, hospital_department_id, email FROM staff_records WHERE staff_id = ?";
    ...
    // Insert request into user_requests table
    $insert_query = "INSERT INTO user_requests (staff_id, staff_email, request_type, hospital_department_id, request_status, date_submitted) 
    ...
    $stmt->bind_param(
        ...
        $staff_data['email'], 
        $request_type, 
        $staff_data['hospital_department_id']
    );
      ...
      <div class="main-content">
        ...
        <div class="inside-content">
            <section class="settings_section" id="settings_hub">
                <h2 class="page_title">Request Change:</h2>
                ...
                <div class="form-container">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            <label for="request_type">Change Type:</label>
                            <select name="request_type" id="request_type" required>
                                <option value="Password Change">Password Change</option>
                                <option value="Change User Role">Change User Role</option>
